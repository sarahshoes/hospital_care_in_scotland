...
waiting_times %>% 
  ...
  mutate(percent_variation = (1 - num_meeting_target_by_month/avg_2018_2019)*100) %>% 
...
Q Is it valid to say the number meeting target was higher if the volume of people overall was much lower? Should it all be done in percentage?
A No because it is the number that needs dealt with and A&E should be able to meet targets for BUT the graph above isn't telling us anything useful
