...
Gathering information about the issue, initially from the brief, but also by collecting reports and articles in the media and from research bodies allowed us to better understand the issues faced by the NHS and how they were interpreted by other organisations. Obtaining more information about the issue and the ways it has been approached, made it more likely that we would be able to devise an effective representation of the problem of our own. 
...
The datasets in general required very little cleaning. Transformations were mainly limited to extracting dates from text formats such as “2020Q2” and the calculation of change in value relative to a pre-COVID average (2018/19).  
...
Although covered by license, there is no endoresment or warranty with the data. The licence does not
grant the user of the data any official status or patronage. Further, the provider of the information
is not liable for any errors in the information nor any loss or damage caused by its use. 
