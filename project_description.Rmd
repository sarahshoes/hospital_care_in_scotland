...
Malcolm worked on the following datasets:
Bed Occupancy 
Hospital Admissions
...
The datasets in general required only moderate cleaning. Transformations were mainly limited to extracting dates from text formats such as “2020Q2” and the calculation of change in value relative to a pre-COVID average (2018/19).  
